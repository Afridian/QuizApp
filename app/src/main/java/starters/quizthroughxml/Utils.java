...
/**
 * Created by Murad on 11/17/2017.
 */
public class Utils{

    final static public int CATEGORY_COMPUTER = 18;
    ...
    final static public String DIFFICULTY_HARD = "hard";


    final static public int CATEGORY = 0;
    final static public int DIFFICULTY = 1;

    final static public int COMPUTER_MENU_ITEM = Menu.FIRST;
